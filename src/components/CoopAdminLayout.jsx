...
const HTX_TRANSLATIONS = {
  ...
  ko: {
    ...
    schedule_loc: "위치:",
    schedule_time: "시간:",
    schedule_driver: "기사/차량:",
    schedule_weight: "탑재량",
    schedule_goods: "상품:",
    schedule_track: "추적",
    schedule_st_depart: "출발 예정",
    schedule_st_loading: "로딩 중",
    schedule_st_wait: "대기 중",
    schedule_item_veg: "배추, 무",
    schedule_item_fruits: "혼합 과일",
    schedule_item_rice: "재스민 쌀, 벽돌",
    schedule_dest_1: "그린 마트",
    schedule_dest_2: "SG 항구",
    schedule_dest_3: "Go 슈퍼마켓",
    cert_remind: "앱 알림",
  }
};
